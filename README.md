...
- **Live TUI Dashboard**: A real-time terminal interface displaying nearby Access Points, connected clients, BLE devices, and live probe requests.
...
- **Deauthentication Attack**: 
  - **Broadcast**: Kick all clients off a specific Access Point.
  - **Targeted**: Identify specific connected clients (e.g., an iPhone or Laptop) and kick only that device.
...
- **Channel Hopping**: Automatically cycle through WiFi channels 1–165 to capture 100% of local wireless traffic.
